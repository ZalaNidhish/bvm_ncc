...
const aims = [
  { emoji: "🎯", title: "Develop Character", desc: "Cultivate integrity, moral courage, and ethical values that define a responsible citizen and a dependable leader." },
  { emoji: "🌟", title: "Build Leadership", desc: "Train cadets to take initiative, manage teams under pressure, and lead with confidence in any environment." },
  { emoji: "⚖️", title: "Promote Discipline", desc: "Foster punctuality, precision, and adherence to duty — habits that translate into excellence in every field." },
  { emoji: "🤝", title: "Encourage Social Service", desc: "Instil a spirit of selfless service through community engagement, disaster relief, and national development activities." },
  { emoji: "🕊️", title: "Secular Outlook", desc: "Promote unity among cadets from all religions, regions, and communities to build a truly inclusive national force." },
  { emoji: "🛡️", title: "National Manpower Reserve", desc: "Create a pool of trained, disciplined youth ready to serve the nation in times of need as a strategic reserve." },
];
...
const activities = [
  ...
  { emoji: "🧗", label: "Adventure Activities", sub: "Rock climbing, rappelling" },
...
const benefits = [
  { emoji: "👑", title: "Leadership Skills", desc: "Hands-on experience leading teams in drills, camps, and community projects builds real-world leadership capability." },
  { emoji: "📜", title: "NCC Certificates A, B & C", desc: "Certificates carry significant weightage in college admissions, government job applications, and defence recruitment." },
  { emoji: "⭐", title: "Defence Recruitment Preference", desc: "NCC 'C' Certificate holders get direct entry bonus marks and exemptions in armed forces recruitment across Army, Navy, and Air Force." },
  { emoji: "🎤", title: "Personality Development", desc: "Regular drills, public speaking, and national-level exposure transform cadets into confident, well-spoken individuals." },
  { emoji: "🌍", title: "National Opportunities", desc: "Cadets can represent their state at RDC (New Delhi), Thal Sainik Camp, Youth Exchange Programme, and international events." },
  { emoji: "🤝", title: "Teamwork & Camaraderie", desc: "Life-long bonds formed through shared hardships in camps and parades — a network that spans the entire country." },
  { emoji: "🎓", title: "Extra Marks & Admission Preference", desc: "Many universities and state boards award extra marks or seats to NCC certificate holders during admissions." },
  { emoji: "💪", title: "Physical & Mental Fitness", desc: "Structured PT, drills, and adventure activities build stamina, resilience, and a disciplined lifestyle." },
];
...
const certificates = [
  {
    ...
    textColor: "#1d4ed8",
    subColor: "#3b82f6",
    eligibility: "Awarded to Junior Division / Junior Wing cadets (school level) upon passing the 'A' Certificate Examination conducted by the respective Directorate.",
    requirements: [
    ...
    benefits: "Earns bonus marks in school board exams in several states. Acts as a foundation for further NCC training.",
  },
  {
    name: "Certificate B",
    ...
    textColor: "#b45309",
    subColor: "#f59e0b",
    eligibility: "Awarded to Senior Division / Senior Wing cadets (college level) on passing the 'B' Certificate Examination after a minimum of two years of NCC service.",
    requirements: [
    ...
    benefits: "Awarded preference in college admissions, police recruitment, and several state government jobs. Mandatory for 'C' Certificate eligibility.",
  },
  {
    name: "Certificate C",
    ...
    textColor: "#047857",
    subColor: "#10b981",
    eligibility: "The most prestigious NCC certificate, awarded after completion of SD/SW training with minimum three years of service and participation in a national-level camp.",
    requirements: [
    ...
    benefits: "Carries significant weightage in UPSC, SSB interviews, police services, and direct entry schemes in the Indian Army, Navy, and Air Force.",
  },
];

const divisions = [
  { division: "Junior Division (JD)", who: "School Boys", age: "13 – 18 yrs", wing: "Army" },
  { division: "Junior Wing (JW)", who: "School Girls", age: "13 – 18 yrs", wing: "Army / Air / Naval" },
  { division: "Senior Division (SD)", who: "College Boys", age: "18 – 26 yrs", wing: "Army" },
  { division: "Senior Wing (SW)", who: "College Girls", age: "18 – 26 yrs", wing: "Army / Air / Naval" },
];
...
const nccHistory = [
  { year: "1948", event: "NCC established under the NCC Act, succeeding the University Corps of British India." },
  { year: "1950", event: "Naval and Air wings added; NCC expanded to a tri-service organisation." },
  { year: "1952", event: "Girls Division created — NCC becomes fully inclusive across genders." },
  { year: "1968", event: "Motto 'Unity and Discipline' officially adopted as the cornerstone of NCC's identity." },
  { year: "2001", event: "NCC strength crosses 10 lakh cadets, making it the world's largest uniformed youth organisation." },
  { year: "2020", event: "NCC expansion announced — coverage extended to border and coastal districts for national security focus." },
];
...
function FlagRow({ color, label, wing, desc }) {
  return (
    <div style={styles.flagRow}>
      ...
      <div>
        <p style={styles.flagWing}><strong>{label}</strong> — {wing}</p>
...
const styles = {
  ...
  heroOverlay1: { position: "absolute", top: -40, right: -40, width: 220, height: 220, borderRadius: "50%", background: "rgba(255,255,255,0.04)", pointerEvents: "none" },
  heroOverlay2: { position: "absolute", bottom: -60, left: "35%", width: 320, height: 320, borderRadius: "50%", background: "rgba(255,255,255,0.025)", pointerEvents: "none" },
  heroContent: { display: "flex", alignItems: "center", gap: 16, marginBottom: 16 },
  heroBadge: { width: 48, height: 48, borderRadius: 10, background: "rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", flexShrink: 0 },
  heroEyebrow: { color: "rgba(255,255,255,0.55)", fontSize: 12, margin: 0, letterSpacing: 2, textTransform: "uppercase" },
  ...
  certGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 },
  certCard: { border: "1.5px solid", borderRadius: 12, padding: 22, position: "relative", overflow: "hidden" },
  certBar: { position: "absolute", top: 0, left: 0, right: 0, height: 4 },
  certHeader: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16, marginTop: 8 },
